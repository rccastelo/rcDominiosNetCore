        ...
        public EstadoCivilTransfer ValidarConsulta(EstadoCivilTransfer estadoCivilTransfer) 
        {
            ...
            try  {
                ...
                if (estadoCivilValidacao != null) {
                    estadoCivilValidacao.Descricao = Tratamento.TratarStringNuloBranco(estadoCivilValidacao.Descricao);
                    estadoCivilValidacao.Codigo = Tratamento.TratarStringNuloBranco(estadoCivilValidacao.Codigo);
